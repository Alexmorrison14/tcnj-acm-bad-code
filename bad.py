...
# wer = a | {55 // 11} | {howdy('sick dudesfsd'), howdy('a') ** 2, howdy('10234'), howdy('m')}
#
#
# def probably_okay():
...
#
#
# x = {g % ((howdy('4') + 3) * 2) for g in (
#         wer | {howdy('4') + 5} | {howdy('4') * 2 - 3} | {19, 21} | probably_okay() | {13} | oh_my(1, 2, 10) | oh_my(
#     -2, 5, -2) | {11, 2, 4, 6, 8, 9})}
#
# j = list(x)
# shuffle(j)
...
print(random.sample(alphabet_letters, len(alphabet_letters)))
